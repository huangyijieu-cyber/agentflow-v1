...
class ActorRolloutRefWorker(Worker, DistProfilerExtension):
    ...
    def __init__(self, config: DictConfig, role: str, **kwargs):
        ...
        if not torch.distributed.is_initialized():
            ...
            torch.distributed.init_process_group(
                ...
                timeout=datetime.timedelta(seconds=self.config.get("nccl_timeout", 1200 * 10)),
    ...
    @DistProfiler.annotate(color="red", role="actor_update_by_dpo")
    def update_actor_by_dpo(self, data: DataProto):
        ...
        with self.ulysses_sharding_manager:
            ...
            # perform training
            with Timer(name="update_policy_by_dpo", logger=None) as timer:
                metrics = self.actor.update_policy_by_dpo(data=data)
